...
if __name__ == '__main__':
    ...
    corpus_root_xml = nltk.data.find('/Users/yuri/Desktop/Autism_SLI_textAnalyzer_NLP_ML/xml')
    corpus_root_plain = '/Users/yuri/Desktop/Autism_SLI_textAnalyzer_NLP_ML/plain_text'
    ...
    # Testing to see if it is happening
    print(len(corpus_xml.fileids()))
